  ...
  return (
    <div>
      ...
      <div className="text-center mb-8 sm:mb-16 RobotoFont">
        <p className="text-[30px] sm:text-[100px] mb-8 sm:mb-16">Restaurant Picker</p>
        <p className="text-[15px] sm:text-[50px]">Please enter a number for the following food categories:</p>
        <p className="text-[15px] sm:text-[50px]">1. Japanese 2. Korean 3. Chinese</p>
      </div>
...
<div className="flex items-center">   
    ...
    <button className="sm:p-2.5 ms-3 sm:ms-5 text-sm font-medium text-white  focus:outline-none ">
