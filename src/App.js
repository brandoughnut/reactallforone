...
<div className="hidden sm:block">
          ...
          <Button color="bg-[#EE8096]" className="block text-black bg-[#EE8096] font-medium rounded-2xl text-sm px-4 py-7 text-center RobotoFont" onClick={() => setOpenModal(true)}>
